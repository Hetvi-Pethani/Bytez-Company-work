...
const Otp = () => {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8000/userOtp', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                toast.warn(data.message || 'Invalid OTP');
            }
        } catch (err) {
    ...
    return (
        <div>
            ...
            {/* [Head] start */}
            <title>Otp | Mantis Bootstrap 5 Admin Template</title>
            {/* [Meta] */}
            <meta charSet="utf-8" />
                    ...
                    <div className="auth-wrapper v3">
                        <div className="auth-form">
                            ...
                            <div className="card my-5">
                                <form method="post" onSubmit={(e) => { e.preventDefault(); handleVerifyOtp(); }}>
                                    <div className="card-body">
                                        <div className="d-flex justify-content-between align-items-end mb-4">
                                            <h3 className="mb-0"><b>Otp</b></h3>
