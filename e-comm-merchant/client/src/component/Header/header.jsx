        ...
        <div>
            ...
            <nav className="pc-sidebar">
                <div className="navbar-wrapper">
                    ...
                    <div className="navbar-content" style={{ maxHeight: '100vh', overflowY: 'auto' }}>
                        <ul className="pc-navbar">
                            ...
                            <li className={`pc-item pc-hasmenu ${isProductOpen ? 'open' : ''}`}>
                                <a
                                    href="#!"
                                    className="pc-link"
                                    onClick={(e) => {
                                ...
                                >
                                    ...
                                    <span className="pc-mtext">Bills</span>
                                    <span className="pc-arrow">
                                        <i className={`ti ti-chevron-right transition-transform duration-300 ${isProductOpen ? 'rotate-100' : ''}`} />
                                    </span>
                                </a>
                                {isProductOpen && (
                                    <ul>
                            ...
                            <li className="pc-item">
                                <a href="/stock" className="pc-link">
                                    <span className="pc-micon"><i className="ti ti-trending-up" /></span>
                                    <span className="pc-mtext">Stock Manage</span>
                                </a>
                            </li>

                            <li className={`pc-item pc-hasmenu ${isEcommerceOpen ? 'open' : ''}`}>
                                <a
                                    href="#!"
                                    className="pc-link"
                                    onClick={(e) => {
                                ...
                                >
                                    ...
                                    <span className="pc-mtext">Product Management</span>
                                    <span className="pc-arrow">
                                        <i className={`ti ti-chevron-right transition-transform duration-300 ${isEcommerceOpen ? 'rotate-100' : ''}`} />
                                    </span>
                                </a>

                                {isEcommerceOpen && (
                                    <ul>
                                        <li className="pc-item"><a className="pc-link" href="/category">Category</a></li>
                                        <li className="pc-item"><a className="pc-link" href="/subcategory">Sub Category</a></li>
                                        <li className="pc-item"><a className="pc-link" href="/product">Product</a></li>
                                        <li className={`pc-item pc-hasmenu  ${isMastersOpen ? 'open' : ''}`}>
                                            <a
                                                href="#!"
                                                className="pc-link"
                                                onClick={(e) => {
                                            ...
                                            >
                                                ...
                                                <span className="pc-mtext">Masters</span>
                                                <span className="pc-arrow">
                                                    <i className={`ti ti-chevron-right transition-transform duration-200 ${isMastersOpen ? 'rotate-90' : ''}`} />
                                                </span>
                                            </a>

                                            {isMastersOpen && (
                                                <ul>
                                                    <li className="pc-item"><a className="pc-link" href="/size">Size</a></li>
                                                    <li className="pc-item"><a className="pc-link" href="/color">Color</a></li>
                                                </ul>
                                            )}
                                        </li>
                                    </ul>
                            ...
                            <li className="pc-item">
                                <a href="/merchant" className="pc-link">
